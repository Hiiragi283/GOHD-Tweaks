...
public class RightClickBlock {
    ...
    public void onRightClickBlock(PlayerInteractEvent.RightClickBlock event) {
        ...
        if (!event.getWorld().isRemote) {
            ...
            RagiLogger.infoDebug(stack);
            RagiLogger.infoDebug(item);
            RagiLogger.infoDebug(stackCompare);
            RagiLogger.infoDebug(player);
            RagiLogger.infoDebug(world);
            RagiLogger.infoDebug(pos);
            RagiLogger.infoDebug(state);
            RagiLogger.infoDebug(block);
            //デバッグ用
